...
import { MainNav } from '@/components/stock-manager/layout/main-nav';
import { SideNav } from '@/components/stock-manager/layout/side-nav';

export const metadata: Metadata = {
  title: {
    default: 'Stock Manager Dashboard',
    template: '%s | Nigedease Stock Manager',
  },
  description: 'Nigedease Stock Manager Dashboard and Inventory Management System',
};
