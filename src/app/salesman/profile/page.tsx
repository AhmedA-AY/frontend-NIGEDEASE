          ...
          <Grid container spacing={3}>
                ...
                <CardContent sx={{ p: 3, textAlign: 'center' }}>
                  ...
                  >
                    {!profileData.profile_image && (
                      <ShoppingCartIcon weight="bold" fontSize="3.5rem" />
                    )}
                  </Avatar>
                  ...
                  <Box sx={{ mt: 2, p: 1, bgcolor: 'info.lighter', borderRadius: 1 }}>
                    <Typography variant="body2" color="info.main">
                      Sales representative with access to customer and sales features
                    </Typography>
                  </Box>
                </CardContent>
              </Card>
            ...
            <Grid item xs={12} md={8}>
              <Card component="form" onSubmit={handleSubmit}>
                <CardHeader 
                  title="Edit Profile" 
                  subheader="Update your salesman account details"
                />
                <Divider />
                <CardContent sx={{ p: 3 }}>
                  {updateSuccess && (
