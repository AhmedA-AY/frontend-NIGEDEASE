...
export const inventoryApi = {
  ...
  getProductUnits: async (): Promise<ProductUnit[]> => {
    const response = await coreApiClient.get<ProductUnit[]>('/inventory/product-units/');
    return response.data;
  },
  
  getProductUnit: async (id: string): Promise<ProductUnit> => {
    const response = await coreApiClient.get<ProductUnit>(`/inventory/product-units/${id}/`);
    return response.data;
  },
  
  createProductUnit: async (data: ProductUnitCreateData): Promise<ProductUnit> => {
    const response = await coreApiClient.post<ProductUnit>('/inventory/product-units/', data);
    return response.data;
  },
  
  updateProductUnit: async (id: string, data: ProductUnitUpdateData): Promise<ProductUnit> => {
    const response = await coreApiClient.put<ProductUnit>(`/inventory/product-units/${id}/`, data);
    return response.data;
  },
  
  deleteProductUnit: async (id: string): Promise<void> => {
    await coreApiClient.delete(`/inventory/product-units/${id}/`);
  },

  // Product Categories
  getProductCategories: async (): Promise<ProductCategory[]> => {
    console.log('Fetching product categories from /inventory/product-categories/');
    const response = await coreApiClient.get<ProductCategory[]>('/inventory/product-categories/');
    return response.data;
  },
  
  getProductCategory: async (id: string): Promise<ProductCategory> => {
    console.log(`Fetching product category with ID ${id} from /inventory/product-categories/${id}/`);
    const response = await coreApiClient.get<ProductCategory>(`/inventory/product-categories/${id}/`);
    return response.data;
  },
  ...
  createProductCategory: async (data: ProductCategoryCreateData): Promise<ProductCategory> => {
    ...
    try {
      const response = await coreApiClient.post<ProductCategory>('/inventory/product-categories/', data);
  ...
  updateProductCategory: async (id: string, data: ProductCategoryUpdateData): Promise<ProductCategory> => {
    console.log(`Updating product category with ID ${id} and data:`, data);
    const response = await coreApiClient.put<ProductCategory>(`/inventory/product-categories/${id}/`, data);
    return response.data;
  },
  
  deleteProductCategory: async (id: string): Promise<void> => {
    console.log(`Deleting product category with ID ${id}`);
    await coreApiClient.delete(`/inventory/product-categories/${id}/`);
  },

  // Products
  getProducts: async (): Promise<Product[]> => {
    const response = await coreApiClient.get<Product[]>('/inventory/products/');
    return response.data;
  },
  
  getProduct: async (id: string): Promise<Product> => {
    const response = await coreApiClient.get<Product>(`/inventory/products/${id}/`);
    return response.data;
  },
  
  createProduct: async (data: ProductCreateData): Promise<Product> => {
    const response = await coreApiClient.post<Product>('/inventory/products/', data);
    return response.data;
  },
  
  updateProduct: async (id: string, data: ProductUpdateData): Promise<Product> => {
    const response = await coreApiClient.put<Product>(`/inventory/products/${id}/`, data);
    return response.data;
  },
  
  deleteProduct: async (id: string): Promise<void> => {
    await coreApiClient.delete(`/inventory/products/${id}/`);
  },
  ...
  getInventories: async (): Promise<Inventory[]> => {
    const response = await coreApiClient.get<Inventory[]>('/inventory/inventories/');
    return response.data;
  },
  
  getInventory: async (id: string): Promise<Inventory> => {
    const response = await coreApiClient.get<Inventory>(`/inventory/inventories/${id}/`);
    return response.data;
  },
  
  createInventory: async (data: InventoryCreateData): Promise<Inventory> => {
    const response = await coreApiClient.post<Inventory>('/inventory/inventories/', data);
    return response.data;
  },
  
  updateInventory: async (id: string, data: InventoryUpdateData): Promise<Inventory> => {
    const response = await coreApiClient.put<Inventory>(`/inventory/inventories/${id}/`, data);
    return response.data;
  },
  
  deleteInventory: async (id: string): Promise<void> => {
    await coreApiClient.delete(`/inventory/inventories/${id}/`);
  },
