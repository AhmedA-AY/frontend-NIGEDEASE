...
interface DynamicApexChartProps {
  type: 'line' | 'area' | 'bar' | 'pie' | 'donut' | 'scatter' | 'bubble' | 'heatmap' | 'candlestick' | 'boxPlot' | 'radar' | 'polarArea' | 'rangeBar' | 'treemap';
  series: any[];
  options: ApexOptions;
  height?: number;
  width?: number | string;
...
export default function DynamicApexChart({ type, series, options, height = 400, width = '100%' }: DynamicApexChartProps) {
